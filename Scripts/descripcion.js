let nombreper=["BRUJA NOCTURNA","ARQUERO","LOS PILLOS","PRINCIPE",
"GOBLIN","MONTA PUERCOS","PEKKA","MINERO","CABALLERO","GOLEM"];

localStorage.setItem("Nombres", JSON.stringify(nombreper));

export let descripcionArray =[
    {
    ...
    },
    {
        ...
        imagen :"/Imagenes/montaPuercos.webp"
    },
    {
        nombre : "PEKKA",
    ...
    },
    {
        ...
        imagen :"/Imagenes/Miner_info.webp"
    },
    {
        nombre : "CABALLERO",
